          ...
          <div className="w-full flex flex-col max-w-4xl flex-1 gap-16 mx-auto">
            ...
            <section className="scroll-mt-20 text-left" id="about">
              ...
              <p className="text-text-secondary text-base sm:text-lg font-normal leading-relaxed">
                I have 17+ years of working as a Senior Software Developer with
                extensive experience in software development, including object
                oriented programming, patterns, principles, software
                methodologies with various development tools, web (front-end &
                back-end) and android(xamarin) applications. I am using
                technical and analytical skills to problem solve both
                independently, as well as part of a group. I worked with
                Angular, TypeScript, C#, HTML, CSS and JavaScript technologies
                last six years before 2024, nowadays working Principal Frontend
                Developer.
              </p>
            </section>
            {/* Experience Section */}
            ...
            <footer className="mt-12 text-center text-text-secondary text-sm border-t border-gray-200 pt-6">
              &copy; {new Date().getFullYear()} Samet ÇELİKBIÇAK. All rights
              reserved.
            </footer>
          </div>
        </main>
